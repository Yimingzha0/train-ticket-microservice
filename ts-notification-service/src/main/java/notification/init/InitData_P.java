package notification.init;

import notification.entity.Payment;
import notification.repository.PaymentRepository;
import notification.service.PaymentService;
 ...
 */
@Component
public class InitData_P implements CommandLineRunner {
    @Autowired
