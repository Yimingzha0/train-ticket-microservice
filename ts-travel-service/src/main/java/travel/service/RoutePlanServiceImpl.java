...
public class RoutePlanServiceImpl implements RoutePlanService {
    ...
    public Response searchMinStopStations(RoutePlanInfo info, HttpHeaders headers) {
        ...
        Response<ArrayList<Route>> re = routeService.getRouteByStartAndEnd(info.getStartStation(), info.getEndStation(), headers);
        ArrayList<Route> routeList = re.getData();
    ...
    private Route getRouteByRouteId(String routeId, HttpHeaders headers) {
       ...
       /* String route_service_url = getServiceUrl("ts-travel-service");
        ...
        Response<Route> result = routeService.getRouteById(routeId, headers);
