...
import train.service.TrainFoodService;
...
@Component
public class InitData_T implements CommandLineRunner{

    @Autowired
    TrainFoodService trainFoodService;

    private static final Logger LOGGER = LoggerFactory.getLogger(InitData_T.class);
    ...
    public void run(String... args) throws Exception {
        ...
        try{
            ...
            InitData_T.LOGGER.info("the trainfood.txt has format error!");
            InitData_T.LOGGER.error(e.getMessage());
            System.exit(1);
        }
    }

    private List<Food> toFoodList(String s){
        InitData_T.LOGGER.info("s= {}", s);
