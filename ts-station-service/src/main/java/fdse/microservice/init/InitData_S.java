...
import fdse.microservice.service.StationFoodService;
...
@Component
public class InitData_S implements CommandLineRunner{

    @Autowired
    StationFoodService service;

    private static final Logger LOGGER = LoggerFactory.getLogger(InitData_S.class);
    ...
    public void run(String... args) throws Exception {
        ...
        try{
            ...
            InitData_S.LOGGER.info("the foodstores.txt has format error!");
            InitData_S.LOGGER.error(e.getMessage());
            System.exit(1);
        }
