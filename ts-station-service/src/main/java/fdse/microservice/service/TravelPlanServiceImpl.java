...
import fdse.microservice.entity.TransferTravelInfo;
import fdse.microservice.entity.TransferTravelResult;
import fdse.microservice.entity.TravelAdvanceResultUnit;
...
public class TravelPlanServiceImpl implements TravelPlanService {
    ...
    private ArrayList<RoutePlanResultUnit> getRoutePlanResultCheapest(RoutePlanInfo info, HttpHeaders headers) {
        ...
        String route_plan_service_url = getServiceUrl("ts-travel-service");
