...
import fdse.microservice.repository.TripRepository;
...
public class TravelServiceImpl implements TravelService {
    ...
    public Response getTripAllDetailInfo(TripAllDetailInfo gtdi, HttpHeaders headers) {
        fdse.microservice.entity.TripAllDetail gtdr = new fdse.microservice.entity.TripAllDetail();
    ...
    private List<TripResponse> getTicketsByBatch(List<Trip> trips, String startPlaceName, String endPlaceName, String departureTime, HttpHeaders headers) {
        ...
        List<fdse.microservice.entity.Travel> infos = new ArrayList<>();
        Map<String, Trip> tripMap = new HashMap<>();
        for(Trip trip: trips){
            fdse.microservice.entity.Travel query = new fdse.microservice.entity.Travel();
            query.setTrip(trip);
    ...
    public Response adminQueryAll(HttpHeaders headers) {
        List<fdse.microservice.entity.Trip> trips = repository.findAll();
        ArrayList<fdse.microservice.entity.AdminTrip> adminTrips = new ArrayList<>();
        if(trips != null){
            for (fdse.microservice.entity.Trip trip : trips) {
                fdse.microservice.entity.AdminTrip adminTrip = new fdse.microservice.entity.AdminTrip();
