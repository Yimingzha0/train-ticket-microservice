...
import contacts.entity.Consign;
import contacts.entity.ConsignRecord;
import contacts.repository.ConsignRepository;
...
public class ConsignServiceImpl implements ConsignService {
    ...
    public Response insertConsignRecord(Consign consignRequest, HttpHeaders headers) {
        ...
        String consign_price_service_url = getServiceUrl("ts-contacts-service");
